...
/**
 * This is the item provider adapter for a {@link classdiagram.Note} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NoteItemProvider 
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
    if (itemPropertyDescriptors == null) {
      ...
      addNotedElementPropertyDescriptor(object);
  ...
  /**
   * This adds a property descriptor for the Noted Element feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addNotedElementPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Note_notedElement_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Note_notedElement_feature", "_UI_Note_type"),
         ClassdiagramPackage.Literals.NOTE__NOTED_ELEMENT,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ClassdiagramPackage.Literals.NOTE__CONTENT,
         true,
         false,
         false,
  ...
  public String getText(Object object) {
    String label = ((Note)object).getContent();
