...
public class AssociationItemProvider extends NamedElementItemProvider {
  ...
  public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
    if (itemPropertyDescriptors == null) {
      ...
      addAssociationClassPropertyDescriptor(object);
    }
   ...
   * @generated
   */
  protected void addAssociationClassPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Association_associationClass_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Association_associationClass_feature", "_UI_Association_type"),
         ClassdiagramPackage.Literals.ASSOCIATION__ASSOCIATION_CLASS,
         true,
         false,
         true,
         null,
