 ...
 * @generated
 */
public class FillInTheBlanksQuizItemProvider extends QuizItemProvider {
  /**
   ...
   * @generated
   */
  public FillInTheBlanksQuizItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This returns FillInTheBlanksQuiz.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/FillInTheBlanksQuiz"));
  }
  ...
  public String getText(Object object) {
    String label = ((FillInTheBlanksQuiz)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_FillInTheBlanksQuiz_type") :
      getString("_UI_FillInTheBlanksQuiz_type") + " " + label;
  }
