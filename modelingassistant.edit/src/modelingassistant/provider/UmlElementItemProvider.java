...
/**
 * This is the item provider adapter for a {@link modelingassistant.UmlElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  protected void addLearningItemsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_UmlElement_learningItems_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_UmlElement_learningItems_feature", "_UI_UmlElement_type"),
         ModelingassistantPackage.Literals.UML_ELEMENT__LEARNING_ITEMS,
         true,
         false,
         true,
         null,
