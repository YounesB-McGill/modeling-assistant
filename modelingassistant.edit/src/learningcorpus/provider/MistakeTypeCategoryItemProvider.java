...
/**
 * This is the item provider adapter for a {@link learningcorpus.MistakeTypeCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MistakeTypeCategoryItemProvider extends NamedElementItemProvider {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         LearningcorpusPackage.Literals.MISTAKE_TYPE_CATEGORY__SUPERCATEGORY,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         LearningcorpusPackage.Literals.MISTAKE_TYPE_CATEGORY__SUBCATEGORIES,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(LearningcorpusPackage.Literals.MISTAKE_TYPE_CATEGORY__MISTAKE_TYPES);
    }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(MistakeTypeCategory.class)) {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (LearningcorpusPackage.Literals.MISTAKE_TYPE_CATEGORY__MISTAKE_TYPES,
         LearningcorpusFactory.eINSTANCE.createMistakeType()));
  }
