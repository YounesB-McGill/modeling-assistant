...
/**
 * This is the item provider adapter for a {@link learningcorpus.LearningItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LearningItemItemProvider extends NamedElementItemProvider {
  /**
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         LearningcorpusPackage.Literals.LEARNING_ITEM__LEARNING_RESOURCES,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         LearningcorpusPackage.Literals.LEARNING_ITEM__MISTAKE_TYPES,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         LearningcorpusPackage.Literals.LEARNING_ITEM__DESCRIPTION,
         true,
         false,
         false,
