...
public class MistakeDetectionWrongRelationshipsTest {
  ...
  public void testMistakeIncorrectRoleName() {
    ...
    AssociationEnd instructorMyDriverAssociationEnd =
        MistakeDetectionTest.getAssociationEndFromClass("myDriver", instructorBusClass);

    AssociationEnd studentMyDrivrAssociationEnd =
        MistakeDetectionTest.getAssociationEndFromClass("myDrivr", studentBusClass);
    ...
    for (Mistake m : studentSolution.getMistakes()) {
      assertTrue(MistakeDetectionTest.assertMistake(m, BAD_ROLE_NAME_SPELLING, studentMyDrivrAssociationEnd,
