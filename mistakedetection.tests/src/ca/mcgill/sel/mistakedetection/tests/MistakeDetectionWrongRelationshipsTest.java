...
public class MistakeDetectionWrongRelationshipsTest {
	...
	public void testToCheckRelationshipMappings() {
		...
		var instructorAssociations = getAssociationsFromClassDiagram(instructorBusClass, instructorDriverClass,
		...
		var studentAssociations = getAssociationsFromClassDiagram(studentBusClass, studentDriverClass,
				studentClassDiagram);
	...
	public void testMistakeMissingComposition() {
		...
		var instructorCompanyToEmployeeAssociation = getAssociationsFromClassDiagram(instructorCompanyClass,
				instructorEmployeeClass, instructorClassDiagram);
	...
	public void testMistakeMissingRootAirplaneComposition() {
		...
		var instructorRootToAirplaneAssociation = getAssociationsFromClassDiagram(instructorRootClass,
				instructorAirplaneClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(1), MISSING_COMPOSITION,
				instructorRootToAirplaneAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingRootAirportComposition() {
		...
		var instructorRootToAirportAssociation = getAssociationsFromClassDiagram(instructorRootClass,
				instructorAirportClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(1), MISSING_COMPOSITION,
				instructorRootToAirportAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingRootCityComposition() {
		...
		var instructorRootToCityAssociation = getAssociationsFromClassDiagram(instructorRootClass, instructorCityClass,
				instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(1), MISSING_COMPOSITION, instructorRootToCityAssociation.get(0),
				0, 1, false);
	}
	...
	public void testMistakeMissingRootPersonComposition() {
		...
		var instructorRootToPeopleAssociation = getAssociationsFromClassDiagram(instructorRootClass,
				instructorPeopleClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(1), MISSING_COMPOSITION,
				instructorRootToPeopleAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingRootPassengerComposition() {
		...
		var studentRootToPassengerAssociation = getAssociationsFromClassDiagram(studentRootClass, studentPassengerClass,
				studentClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), EXTRA_COMPOSITION, studentRootToPassengerAssociation.get(0),
				0, 1, false);
	}
	...
	public void testMistakeMissingRootPilotComposition() {
		...
		var studentRootToPilotAssociation = getAssociationsFromClassDiagram(studentRootClass, studentPilotClass,
				studentClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), EXTRA_COMPOSITION, studentRootToPilotAssociation.get(0), 0,
				1, false);
	}
	...
	public void testMistakeMissingAirplaneAirportAssociation() {
		...
		var instructorAirportToAirplaneAssociation = getAssociationsFromClassDiagram(instructorAirplaneClass,
				instructorAirportClass, instructorClassDiagram);
	...
	public void testMistakeMissingAirplanePersonAssociation() {
		...
		var instructorPersonToAirplaneAssociation = getAssociationsFromClassDiagram(instructorAirplaneClass,
				instructorPersonClass, instructorClassDiagram);
	...
	public void testMistakeMissingAirportCityAssociation() {
		...
		var instructorCityToAirportAssociation = getAssociationsFromClassDiagram(instructorAirportClass,
				instructorCityClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), MISSING_ASSOCIATION,
				instructorCityToAirportAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingCompositionInStudentSolution() {
		...
		var instructorBookToChapterAssociation = getAssociationsFromClassDiagram(instructorBookClass,
				instructorChapterClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(1), MISSING_COMPOSITION,
				instructorBookToChapterAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingAggregation() {
		...
		var instructorTeamToPlayerAssociation = getAssociationsFromClassDiagram(instructorTeamClass,
				instructorPlayerClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), MISSING_AGGREGATION,
				instructorTeamToPlayerAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingAggregationInStudentSolution() {
		...
		var instructorCarToEngineAssociation = getAssociationsFromClassDiagram(instructorCarClass,
				instructorEngineClass, instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), MISSING_AGGREGATION,
				instructorCarToEngineAssociation.get(0), 0, 1, false);
	}
	...
	public void testMistakeMissingAssociation() {
		...
		var instructorCarToOwnerAssociation = getAssociationsFromClassDiagram(instructorCarClass, instructorOwnerClass,
				instructorClassDiagram);
		...
		assertMistake(studentSolution.getMistakes().get(0), MISSING_ASSOCIATION, instructorCarToOwnerAssociation.get(0),
				0, 1, false);
	}
	...
	public void testMistakeMissingAssociationInStudentSolution() {
		...
		var instructorPassengerToAirplanAssociation = getAssociationsFromClassDiagram(instructorPassengerClass,
				instructorAirplanClass, instructorClassDiagram);
	...
	public void testMistakeExtraAssociation() {
		...
		var studentCarToOwnerAssociation = getAssociationsFromClassDiagram(studentOwnerClass, studentCarClass,
				studentClassDiagram);
	...
	public void testMistakeAssocClassSpelling() {
		...
		assertMistake(studentSolution.getMistakes().get(0), BAD_ASSOC_CLASS_NAME_SPELLING, studDriverClass,
				instDriverClass, 0, 1, false);
	}
