...
public class MistakeDetectionPatternTest extends MistakeDetectionBaseTest {
  ...
  public void testStudentSubclassPRPattern() {
    ...
    for (Mistake m : comparison.newMistakes) {
      ...
      assertTrue(!m.getMistakeType().equals(SUBCLASS_SHOULD_BE_FULL_PR_PATTERN));
    }
  }
  ...
  public void testStudentFullPRPattern() {
    ...
    for (Mistake m : comparison.newMistakes) {
      assertTrue(!m.getMistakeType().equals(FULL_PR_PATTERN_SHOULD_BE_ASSOC));
      assertTrue(!m.getMistakeType().equals(FULL_PR_PATTERN_SHOULD_BE_ENUM));
      assertTrue(!m.getMistakeType().equals(FULL_PR_PATTERN_SHOULD_BE_SUBCLASS));
    }
  }
  ...
  public void testFullPRInsteadOfSubclassPattern() {
    ...
    assertMistake(studentSolution.getMistakes().get(0), FULL_PR_PATTERN_SHOULD_BE_SUBCLASS, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testEnumPRInsteadOfSubclassPattern() {
    ...
    studElements.add(getAttributeFromClass("level", studStudentClass));
    studElements.add(getEnumFromClassDiagram("StudentLevel", studentClassDiagram));
    ...
    assertMistake(studentSolution.getMistakes().get(0), ENUM_SHOULD_BE_SUBCLASS_PR_PATTERN, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testAssocPRInsteadOfSubclassPattern() {
    ...
    var studElements =
        getElementsFromClassDiagram(studentClassDiagram, "Student", "fullTimeStudent", "partTimeStudent");
    ...
    assertMistake(studentMistakeFor(studElements.get(0)), ASSOC_SHOULD_BE_SUBCLASS_PR_PATTERN, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testSubPRInsteadOfAssocClassPattern() {
    ...
    assertMistake(studentSolution.getMistakes().get(1), SUBCLASS_SHOULD_BE_ASSOC_PR_PATTERN, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testEnumPRInsteadOfAssocClassPattern() {
    ...
    var studStudentClassMistake = studentMistakeFor(studStudentClass);
    assertMistake(studStudentClassMistake, ENUM_SHOULD_BE_ASSOC_PR_PATTERN, studElements, instElements, 0, 1, false);
  }
  ...
  public void testEnumPRInsteadOfSubclassPatternEmployeeExample() {
    ...
    ArrayList<NamedElement> studElements = new ArrayList<>();
    studElements.add(studEmployeeClass);
    studElements.add(getAttributeFromClass("status", studEmployeeClass));
    var studEnum = getEnumFromClassDiagram("EmployeeStatus", studentClassDiagram);
    studElements.add(studEnum);
  ...
  public void testAssocPRInsteadOfSubclassPatternEmployeeExample() {
    ...
    assertMistake(studentSolution.getMistakes().get(0), ASSOC_SHOULD_BE_SUBCLASS_PR_PATTERN, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testSubPRInsteadOfAssocClassPatternEmployeeExample() {
    ...
    assertMistake(studentSolution.getMistakes().get(0), SUBCLASS_SHOULD_BE_ASSOC_PR_PATTERN, studElements, instElements,
        0, 1, false);
  }
  ...
  public void testEnumPRInsteadOfSubclassPatternBankExample() {
    ...
    studElements.add(getAttributeFromClass("type", studBankAccClass));
  ...
  public void testIncompletePlayerRoleSubClassPatternBankExample() {
    ...
    assertMistake(studentSolution.getMistakes().get(0), INCOMPLETE_PR_PATTERN, studElements, instElements, 0, 1, false);
  }
  ...
  public void testIncompleteAbstractionOccurrenceFullClassPatternEmployeeExample() {
    ...
    var tagGroup = setAbstractionTagToClassInClassDiag("EmployeeStatus", instructorClassDiagram, instructorSolution);
    setOccurrenceTagToClassInClassDiag("Employee", tagGroup, instructorClassDiagram);
    ...
    var instElements = getElementsFromClassDiagram(instructorClassDiagram, "EmployeeSatus", "Employee");
