...
public class HumanValidatedMistakeDetectionFormats {
  ...
  public static final Map<MistakeType, MistakeDetectionFormat> mappings = Map.ofEntries(
      ...
      entry(EXTRA_COMPOSITION, mdf(List.of("compos", "part_assocend", "whole_assocend"), List.of())),
      ...
      entry(MISSING_COMPOSITION, mdf(List.of(), List.of("compos", "part_assocend", "whole_assocend"))),
      ...
      entry(USING_ASSOC_INSTEAD_OF_AGGREGATION, mdf(List.of("assoc", "assocend", "other_assocend"), List.of("aggr", "part_assocend", "whole_assocend"))),
      entry(USING_ASSOC_INSTEAD_OF_COMPOSITION, mdf(List.of("assoc", "assocend", "other_assocend"), List.of("compos", "part_assocend", "whole_assocend"))),
      entry(USING_ATTRIBUTE_INSTEAD_OF_ASSOC, mdf(List.of("attr"), List.of("assocend"))),
      entry(USING_COMPOSITION_INSTEAD_OF_AGGREGATION, mdf(List.of("compos", "part_assocend", "whole_assocend"), List.of("aggr", "part_assocend", "whole_assocend"))),
      entry(USING_COMPOSITION_INSTEAD_OF_ASSOC, mdf(List.of("compos", "part_assocend", "whole_assocend"), List.of("assoc", "assocend", "other_assocend"))),
      entry(USING_DIRECTED_RELATIONSHIP_INSTEAD_OF_UNDIRECTED, mdf(List.of("aggr_compos_or_assoc", "source_assocend", "target_assocend"), List.of("aggr_compos_or_assoc", "assocend", "other_assocend"))),
      entry(USING_UNDIRECTED_RELATIONSHIP_INSTEAD_OF_DIRECTED, mdf(List.of("aggr_compos_or_assoc", "assocend", "other_assocend"), List.of("aggr_compos_or_assoc", "source_assocend", "target_assocend"))),
      ...
      entry(WRONG_RELATIONSHIP_DIRECTION, mdf(List.of("aggr_compos_or_assoc", "source_assocend", "target_assocend"), List.of("aggr_compos_or_assoc", "source_assocend", "target_assocend"))),
