...
public class HumanValidatedMistakeDetectionFormats {
  ...
  public static final Map<MistakeType, MistakeDetectionFormat> mappings = Map.ofEntries(
      ...
      entry(ASSOC_SHOULD_BE_ENUM_PR_PATTERN, mdf(List.of("player_cls", "role_assocend*"), List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"))),
      ...
      entry(CLASS_SHOULD_BE_ABSTRACT, mdf(List.of("cls"), List.of("cls"))),
      ...
      entry(ENUM_SHOULD_BE_ASSOC_PR_PATTERN, mdf(List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"), List.of("player_cls", "role_assocend*"))),
      entry(ENUM_SHOULD_BE_CLASS, mdf(List.of("enum"), List.of("cls"))),
      entry(ENUM_SHOULD_BE_FULL_PR_PATTERN, mdf(List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"), List.of("player_cls", "role_cls*"))),
      entry(ENUM_SHOULD_BE_SUBCLASS_PR_PATTERN, mdf(List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"), List.of("player_cls", "role_cls*"))),
      ...
      entry(FULL_PR_PATTERN_SHOULD_BE_ENUM, mdf(List.of("player_cls", "role_cls*"), List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"))),
      ...
      entry(MISSING_ATTRIBUTE, mdf(List.of("cls"), List.of("attr"))),
      ...
      entry(SUBCLASS_SHOULD_BE_ENUM_PR_PATTERN, mdf(List.of("player_cls", "role_cls*"), List.of("player_cls", "role_attr", "role_enum", "role_enumitem*"))),
      ...
      entry(USING_AGGREGATION_INSTEAD_OF_COMPOSITION, mdf(List.of("aggr", "whole_assocend", "part_assocend"), List.of("compos", "whole_assocend", "part_assocend"))),
      entry(USING_ASSOC_INSTEAD_OF_AGGREGATION, mdf(List.of("assoc", "assocend", "other_assocend"), List.of("aggr", "whole_assocend", "part_assocend"))),
      entry(USING_ASSOC_INSTEAD_OF_COMPOSITION, mdf(List.of("assoc", "assocend", "other_assocend"), List.of("compos", "whole_assocend", "part_assocend"))),
      entry(USING_ATTRIBUTE_INSTEAD_OF_ASSOC, mdf(List.of("attr"), List.of("assocend"))),
      entry(USING_COMPOSITION_INSTEAD_OF_AGGREGATION, mdf(List.of("compos", "whole_assocend", "part_assocend"), List.of("aggr", "whole_assocend", "part_assocend"))),
      entry(USING_COMPOSITION_INSTEAD_OF_ASSOC, mdf(List.of("compos", "whole_assocend", "part_assocend"), List.of("assoc", "assocend", "other_assocend"))),
      entry(USING_DIRECTED_RELATIONSHIP_INSTEAD_OF_UNDIRECTED, mdf(List.of("aggr_compos_or_assoc", "target_assocend", "source_assocend"), List.of("aggr_compos_or_assoc", "assocend", "other_assocend"))),
