...
public class MistakeDetectionConfig {
  ...
  /**
   * Flag to determine if Comparison instances should be tracked, eg, in the
   * MistakeDetectionInformationServicesForLearningCorpus.
   */
  public static boolean trackComparisonInstances = false;
