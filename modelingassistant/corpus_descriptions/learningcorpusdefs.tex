...
% Generation time: 2022-03-24 14:08:57
...
\begin{tabular}{|p{0.9\linewidth}}
A \verb|${stud_role_enumitem0}| can also play the role of one of the other roles at the same time and different features need to be captured for the roles.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
A \verb|${stud_role_enumitem0}| has different features from one of the other roles and this role never changes to another role.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Will the roles of \verb|${stud_role_enumitem*}| ever be occupied at the same time?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
an instance of \verb|${stud_player_cls}| play more than one role out of \verb|${stud_role_cls*}| at different times or at the same time?
\end{tabular} \medskip
