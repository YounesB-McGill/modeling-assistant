...
% Generation time: 2021-12-25 20:52:40
...
\begin{tabular}{|p{0.9\linewidth}}
[Nice try, but] a \verb|${firstRole}| can also play the role of a \verb|${secondRole}|.
\end{tabular} \medskip
...
\subsubsection{Subclass should be association Abstraction-Occurrence pattern}
