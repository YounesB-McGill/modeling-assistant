...
% Generation time: 2022-02-27 01:07:30
...
Instructor elements: Part association end, Whole association end. \medskip
...
Student elements: Part association end, Whole association end. Instructor element: Association. \medskip
...
Student elements: Source association end, Target association end. Instructor elements: Source association end, Target association end. \medskip
...
Student element: . Instructor element: . \medskip
...
Student element: Classes. Instructor element: Classes. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The concepts of \verb|${inst_player_cls}|, \verb|${inst_role_cls*}| and the relationship between them should be modeled with one of the forms of the Player-Role pattern.
\end{tabular} \medskip
