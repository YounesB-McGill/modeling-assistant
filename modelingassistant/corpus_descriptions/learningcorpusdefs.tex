...
% Generation time: 2022-03-21 02:13:18
...
\begin{tabular}{|p{0.9\linewidth}}
The concepts of \verb|${inst_player_cls}| and \verb|${inst_role*}| and the relationship between them should be modeled with one of the forms of the Player-Role pattern.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The concepts of \verb|${inst_player_cls}|, \verb|${inst_role*}| and the relationship between them should be modeled with one of the forms of the Player-Role pattern.
\end{tabular} \medskip
