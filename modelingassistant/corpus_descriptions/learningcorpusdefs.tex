...
% Generation time: 2022-02-17 00:41:09
...
\begin{tabular}{|p{0.9\linewidth}}
Does every \verb|${stud_other_assocend.cls}| have exactly \verb|${stud_other_assocend.lowerBound}| \verb|${stud_other_assocend.rolename}|?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_assocend.rolename}| role name is not correct.
\end{tabular} \medskip

\noindent Level 4: Parametrized response: \medskip

\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_assocend.rolename}| role name should be changed to \verb|${inst_assocend.rolename}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
When creating a generalization between \verb|${stud_sub_cls}| and \verb|${stud_super_class}|, make sure to follow the \textit{checks for proper generalization}.
\end{tabular} \medskip
