...
% Generation time: 2022-06-22 23:23:34
...
\subsubsection{Wrong class name but correct attributes/relationships}
...
\begin{tabular}{|p{0.9\linewidth}}
Add a \verb|${inst_enum}| enumeration.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_enum}| enumeration is missing an item.
\end{tabular} \medskip

\noindent Level 4: Parametrized response: \medskip

\begin{tabular}{|p{0.9\linewidth}}
Add \verb|${inst_enumitem}| to the \verb|${stud_enum}| enumeration.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_attr.cls}|.\verb|${stud_attr}| attribute incorrectly starts with an uppercase letter. Attributes should start with a lowercase letter.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_attr}| already exists in the same class or another class in the generalization hierarchy, so there is no need to include it again.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_attr}| attribute belongs in the \verb|${inst_attr.cls}| class, i.e., a different class in the inheritance hierarchy.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_attr.cls}|.\verb|${stud_attr}| attribute should be of type \verb|${inst_attr.type}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
\verb|${stud_attr}| should be static, because its value is the same for all instances of \verb|${stud_attr.cls}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
\verb|${stud_attr}| should not be static, because its value may be different for instances of \verb|${stud_attr.cls}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
How would you capture that a \verb|${inst_whole_assocend.refcls}| has a \verb|${inst_part_assocend.refcls}|?
\end{tabular} \medskip

\noindent Level 4: Parametrized response: \medskip

\begin{tabular}{|p{0.9\linewidth}}
Use aggregation to model the relationship between \verb|${inst_part_assocend.cls}| and \verb|${inst_whole_assocend.cls}|.
\end{tabular} \medskip
...
Instructor elements: Association, Association ends. \medskip
...
Student elements: Association, Association ends.  \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The relationship between the \verb|${stud_assoc.cls*}| classes is redundant.
\end{tabular} \medskip
...
Student element: Association ends.  \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Is it a good idea to specify that every \verb|${stud_assocend0.cls}| has a minimum of \verb|${stud_assocend0.lowerBound}| \verb|${stud_assocend0}|?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
\verb|${stud_assocend}| should be static, because each \verb|${stud_assocend.cls}| instance is related to the same set of \verb|${stud_assocend.opposite.cls}| instances.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
\verb|${stud_assocend}| should not be static, because different \verb|${stud_assocend.cls}| instances may be related to different \verb|${stud_assocend.opposite.cls}| instances.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Why is \verb|${stud_part_assocend.refcls}| contained in \verb|${stud_whole_assocend.refcls}|?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Please review the \textit{Directionality in Associations} section of the \textit{UML Class Diagram lecture slides}
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Does \verb|${inst_target_assocend.refcls}| need to know about \verb|${inst_source_assocend.refcls}|?
\end{tabular} \medskip

\noindent Level 3: Parametrized response: \medskip

\begin{tabular}{|p{0.9\linewidth}}
The relationship between \verb|${inst_source_assocend.refcls}| and \verb|${inst_target_assocend.refcls}| should be directed[ from \verb|${inst_source_assocend.refcls}| to \verb|${inst_target_assocend.refcls}|].
\end{tabular} \medskip
...
\subsubsection{Reversed relationship direction}

Student elements: Aggregation composition or association, Whole or target association end, Part or source association end. Instructor elements: Aggregation composition or association, Whole or target association end, Part or source association end. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The direction of the relationship between \verb|${stud_part_or_source_assocend.cls}| and \verb|${stud_whole_or_target_assocend.cls}| should be reversed.
\end{tabular} \medskip
...
Student elements: Association, Association end, Other association end. Instructor elements: Association, Association ends. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Use an n-ary association to represent the relationship between the \verb|${inst_assoc.cls*}| classes.
\end{tabular} \medskip
...
Student elements: Association, Association ends. Instructor elements: Association, Association end, Other association end. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Use a binary association to represent the relationship between the \verb|${inst_assoc.cls*}| classes.
\end{tabular} \medskip
...
Student element: Class. Instructor elements: Association, Association ends. \medskip
...
Student elements: Association, Association ends. Instructor element: Class. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Use an intermediate \verb|${inst_cls}| class instead of an n-ary association.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Please review the \textit{Association class} section of the
...
\begin{tabular}{|p{0.9\linewidth}}
Does it make sense to disallow multiple instances of \verb|${stud_cls}| with the same pair of \verb|${stud_assoc.end0.cls}| and \verb|${stud_assoc.end1.cls}| instances?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Use composition to show that the \verb|${inst_part_assocend.refcls}| class is contained in the \verb|${inst_whole_assocend.refcls}| class.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Is it possible for an instance of \verb|${stud_sub_cls}| to turn into an instance of another subclass of \verb|${stud_super_cls}| over its lifetime?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
A feature of the \verb|${stud_super_cls}| class does not make sense for its \verb|${stud_sub_cls}| subclass.
\end{tabular} \medskip
...
\subsubsection{Reversed generalization direction}
...
\noindent Level 4: Highlight specific problem statement elements referring to the instructor element(s) \medskip
...
Instructor elements: Player class, Roles. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The concepts of \verb|${inst_player_cls}| and its roles \verb|${inst_role*}| and the relationship between them should be modeled with one of the forms of the Player-Role pattern.
\end{tabular} \medskip
...
Student elements: Player class, Roles. Instructor elements: Player class, Roles. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| can play more than one role out of \verb|${stud_role_cls*}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| can play more than one role out of \verb|${inst_role_assocend*}| and different features do not need to be captured for the roles.
\end{tabular} \medskip
...
Student elements: Player class, Role classes. Instructor elements: Player class, Role attribute, Role enumeration, Role enumeration items. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| does not need to play more than one role out of \verb|${stud_role_cls*}| at the same time and different features do not need to be captured for the roles.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The roles \verb|${stud_role_assocend*}| have different features that need to be modeled.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The roles \verb|${stud_role_assocend*}| have different features that need to be modeled, but an instance of \verb|${stud_player_cls}| does not change its role over its lifetime.
\end{tabular} \medskip
...
Student elements: Player class, Role association ends. Instructor elements: Player class, Role attribute, Role enumeration, Role enumeration items. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Will the roles \verb|${stud_role_assocend*}| ever be played by an instance of \verb|${stud_player_cls}| at the same time?
\end{tabular} \medskip
...
Student elements: Player class, Role attribute, Role enumeration, Role enumeration items. Instructor elements: Player class, Role classes. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| can play more than one role out of \verb|${stud_role_enumitem*}| at the same time and different features need to be captured for the roles.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The roles \verb|${stud_role_enumitem*}| have different features and never change to another role.
\end{tabular} \medskip
...
Student elements: Player class, Role attribute, Role enumeration, Role enumeration items. Instructor elements: Player class, Role association ends. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Will an instance of \verb|${stud_player_cls}| ever play more than one role out of \verb|${stud_role_enumitem*}| at the same time?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Can an instance of \verb|${stud_player_cls}| play more than one role out of \verb|${stud_role_cls*}| at different times or at the same time?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Do the roles \verb|${stud_role_cls*}| need to have different features?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Do the roles \verb|${stud_role_cls*}| need to have different features and is it possible that more than one role is played by an instance of \verb|${stud_player_cls}| at the same time?
\end{tabular} \medskip
...
Student element: Existing class. Instructor elements: Abstraction class, Occurrence class. \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_existing_cls}| should be part of an Abstraction-Occurrence relationship.
\end{tabular} \medskip
...
\subsubsection{Missing association in Abstraction-Occurrence pattern}
...
\begin{tabular}{|p{0.9\linewidth}}
The \verb|${stud_abs_cls}| and \verb|${stud_occ_cls}| should be in an Abstraction-Occurrence relationship.
\end{tabular} \medskip

\noindent Level 4: Parametrized response: \medskip

\begin{tabular}{|p{0.9\linewidth}}
The relationship between \verb|${stud_abs_cls}| and \verb|${stud_occ_cls}| should be modeled with an association as part of the Abstraction-Occurrence pattern.
\end{tabular} \medskip
