...
% Generation time: 2022-03-21 20:21:48
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| can play more than one role out of \verb|${stud_role*}|.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| can play more than one role out of \verb|${stud_role*}| and different features do not need to be captured for the roles.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
An instance of \verb|${stud_player_cls}| does not need to play more than one role out of \verb|${stud_role*}| at the same time and different features do not need to be captured for the roles.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The roles \verb|${stud_role*}| have different features that need to be modeled.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
The roles \verb|${stud_role*}| have different features that need to be modeled, but an instance of \verb|${stud_player_cls}| does not change its role over its lifetime.
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Will the roles \verb|${stud_role*}| ever be played by an instance of \verb|${stud_player_cls}| at the same time?
\end{tabular} \medskip
...
\begin{tabular}{|p{0.9\linewidth}}
Do the roles \verb|${stud_role_cls*}| need to have different features and is it possible that more than one role is played at the same time?
\end{tabular} \medskip
