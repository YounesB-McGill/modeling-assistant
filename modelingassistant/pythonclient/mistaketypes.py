...
USING_ASSOCIATION_INSTEAD_OF_AGGREGATION: MistakeType = _MTS["Using association instead of aggregation"]
USING_ASSOCIATION_INSTEAD_OF_COMPOSITION: MistakeType = _MTS["Using association instead of composition"]
