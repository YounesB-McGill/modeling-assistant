...
ReferenceType = EEnum('ReferenceType', literals=[
                      'Composition', 'Aggregation', 'Regular', 'Qualified'])
...
class Operation(NamedElement):
    ...
    visibility = EAttribute(eType=VisibilityType, unique=True, derived=False,
                            changeable=True, default_value=VisibilityType.public)
    static = EAttribute(eType=EBoolean, unique=True, derived=False,
                        changeable=True, default_value=False)
    operationType = EAttribute(eType=OperationType, unique=True, derived=False,
                               changeable=True, default_value=OperationType.Normal)
...
class StructuralFeature(TypedElement):
    ...
    static = EAttribute(eType=EBoolean, unique=True, derived=False,
                        changeable=True, default_value=False)
    visibility = EAttribute(eType=VisibilityType, unique=True, derived=False,
                            changeable=True, default_value=VisibilityType.package)
...
class Classifier(ObjectType):
    ...
    typeParameters = EReference(ordered=True, unique=True,
                                containment=True, derived=False, upper=-1)
    associationEnds = EReference(ordered=True, unique=True,
                                 containment=True, derived=False, upper=-1)
...
class AssociationEnd(StructuralFeature):
    ...
    navigable = EAttribute(eType=EBoolean, unique=True, derived=False,
                           changeable=True, default_value=True)
    lowerBound = EAttribute(eType=EInt, unique=True, derived=False,
                            changeable=True, default_value=0)
    upperBound = EAttribute(eType=EInt, unique=True, derived=False,
                            changeable=True, default_value=1)
    referenceType = EAttribute(eType=ReferenceType, unique=True, derived=False,
                               changeable=True, default_value=ReferenceType.Regular)
    ordered = EAttribute(eType=EBoolean, unique=True, derived=False,
                         changeable=True, default_value=False)
    unique = EAttribute(eType=EBoolean, unique=True, derived=False,
                        changeable=True, default_value=True)
    ...
    def getOppositeEnd(self):
        ...
        raise NotImplementedError('operation getOppositeEnd(...) not yet implemented')
...
class ImplementationClass(Classifier):
    ...
    interface = EAttribute(eType=EBoolean, unique=True, derived=False,
                           changeable=True, default_value=False)
