 ...
 * </p>
 * <ul>
 *   <li>{@link learningcorpus.NamedElement#getName <em>Name</em>}</li>
 * </ul>
 *
...
public interface NamedElement extends EObject, Comparable<NamedElement> {
   ...
   * @see #setName(String)
   * @see learningcorpus.LearningcorpusPackage#getNamedElement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link learningcorpus.NamedElement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
