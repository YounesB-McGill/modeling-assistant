...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Table Mcq Column Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class TableMcqColumnItemImpl extends MinimalEObjectImpl.Container implements TableMcqColumnItem {
  /**
   ...
   * @generated
   */
  protected TableMcqColumnItemImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return LearningcorpusquizPackage.Literals.TABLE_MCQ_COLUMN_ITEM;
  }
  ...
  public void setText(String newText) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__TEXT, oldText, text));
  }
  ...
  public TableMultipleChoiceQuiz getQuiz() {
    if (eContainerFeatureID() != LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ) return null;
  ...
  public NotificationChain basicSetQuiz(TableMultipleChoiceQuiz newQuiz, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject)newQuiz, LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ, msgs);
    return msgs;
  }
  ...
  public void setQuiz(TableMultipleChoiceQuiz newQuiz) {
    if (newQuiz != eInternalContainer() || (eContainerFeatureID() != LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ && newQuiz != null)) {
      ...
      if (newQuiz != null)
        msgs = ((InternalEObject)newQuiz).eInverseAdd(this, LearningcorpusquizPackage.TABLE_MULTIPLE_CHOICE_QUIZ__COLUMN_ITEMS, TableMultipleChoiceQuiz.class, msgs);
      msgs = basicSetQuiz(newQuiz, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ, newQuiz, newQuiz));
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    switch (eContainerFeatureID()) {
      case LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ:
        return eInternalContainer().eInverseRemove(this, LearningcorpusquizPackage.TABLE_MULTIPLE_CHOICE_QUIZ__COLUMN_ITEMS, TableMultipleChoiceQuiz.class, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    switch (featureID) {
      case LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__TEXT:
        return getText();
      case LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__QUIZ:
        return getQuiz();
      case LearningcorpusquizPackage.TABLE_MCQ_COLUMN_ITEM__CORRECT_ENTRIES:
