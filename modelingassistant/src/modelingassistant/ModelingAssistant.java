...
import modelingassistant.impl.ModelingAssistantImpl;
...
public interface ModelingAssistant extends EObject {
  ...
  static ModelingAssistant fromFile(File file) {
    ...
    var rset = ModelingAssistantImpl.getResourceSetWithExtensions();
    try {
  ...
  static ModelingAssistant fromEcoreString(String maString) {
    ...
    ModelingassistantPackage.eINSTANCE.eClass();
    var resource = ModelingAssistantImpl.getResourceSetWithExtensions()
        .createResource(URI.createFileURI("*.modelingassistant"));
    try {
