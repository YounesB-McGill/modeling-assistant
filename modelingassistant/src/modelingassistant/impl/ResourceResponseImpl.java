 ...
 * </p>
 * <ul>
 *   <li>{@link modelingassistant.impl.ResourceResponseImpl#getLearningResources <em>Learning Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceResponseImpl extends FeedbackImpl implements ResourceResponse {
  ...
  protected EClass eStaticClass() {
    return ModelingassistantPackage.Literals.RESOURCE_RESPONSE;
  }
  ...
  public EList<LearningResource> getLearningResources() {
    if (learningResources == null) {
      learningResources = new EObjectWithInverseResolvingEList.ManyInverse<LearningResource>(LearningResource.class, this, ModelingassistantPackage.RESOURCE_RESPONSE__LEARNING_RESOURCES, ModelingassistantPackage.LEARNING_RESOURCE__RESOURCE_RESPONSES);
    }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    switch (featureID) {
      case ModelingassistantPackage.RESOURCE_RESPONSE__LEARNING_RESOURCES:
