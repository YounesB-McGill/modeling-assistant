...
public interface ProblemStatement extends EObject {
   ...
   * @model opposite="problemStatements" required="true"
   * @generated
   */
  ModelingAssistant getModelingAssistant();

  /**
   * Sets the value of the '{@link modelingassistant.ProblemStatement#getModelingAssistant <em>Modeling Assistant</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @model opposite="problemStatement"
   * @generated
   */
