...
def test_all_pr_params_can_be_parsed():
    ...
    assert get_latex_pr_param_parsed_output()
...
def make_and_save_pr_parameters_and_parsed_outputs_markdown_table() -> str:
    "Create the Parametrized Response Parameters and Parsed Outputs Markdown table and save it to a file."
    ...
    for param in get_pr_parameters_to_mistake_types():
        ...
        start_elem = param_start_elem_type(param, as_type=Metatype).example
        parsed_output = parse(param, start_elem)
    ...
    pr_md = dedent("""\
        ...
        is generated by the `make_and_save_pr_parameters_and_parsed_outputs_markdown_table()` function.
...
def get_latex_pr_param_parsed_output() -> str:
    ...
    tex = LatexGenerator.make_tex_table(make_and_save_pr_parameters_and_parsed_outputs_markdown_table())
    print(tex)
    return tex
