...
corpus = LearningCorpus(mistakeTypeCategories=[
    class_mistakes := mtc(n="Class mistakes",
        ...
        subcategories=[
            class_name_mistakes := mtc(n="Class name mistakes", mistakeTypes=[
                plural_class_name := mt(n="Plural class name", atomic=True, stud="cls", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                lowercase_class_name := mt(n="Lowercase class name", atomic=True, stud="cls", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                software_engineering_term := mt(n="Software engineering term", atomic=True, stud="cls", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            enumeration_mistakes := mtc(n="Enumeration mistakes", mistakeTypes=[
                class_should_be_enum := mt(
                    n="Class should be enum", d="Regular class should be enumeration", stud_inst="cls", feedbacks=fbs({
                        1: HighlightSolution(),
                ...
                enum_should_be_class := mt(
                    n="Enum should be class", d="Enumeration should be regular class", stud_inst="cls", feedbacks=fbs({
                        1: HighlightSolution(),
                        2: TextResponse(text="Is there anything special about this class?"),
                ...
                missing_enum := mt(n="Missing enum", d="Missing enumeration", stud_inst="cls", feedbacks=fbs({
                    1: HighlightProblem(),
                ...
                extra_enum := mt(n="Extra enum", d="Extra enumeration", stud_inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                bad_enum_name_spelling := mt(
                    n="Bad enum name spelling", d="Bad enumeration name spelling", stud_inst="cls", feedbacks=fbs({
                        1: HighlightSolution(),
                ...
                missing_enum_item := mt(n="Missing enum item", d="Missing enumeration item", stud_inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                extra_enum_item := mt(n="Extra enum item", d="Extra enumeration item", stud_inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                bad_enum_item_spelling := mt(
                    n="Bad enum item spelling", d="Bad enumeration item spelling", stud_inst="cls", feedbacks=fbs({
                        1: HighlightSolution(),
    ...
    attribute_mistakes := mtc(n="Attribute mistakes",
        mistakeTypes=[
            missing_attribute := mt(n="Missing attribute", stud_inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
        ...
        subcategories=[
            ...
            attribute_in_wrong_class_mistakes := mtc(n="Attribute in wrong class mistakes", mistakeTypes=[
                ...
                attribute_misplaced_in_generalization_hierarchy := mt(
                    n="Attribute misplaced in generalization hierarchy", stud="attr", inst=[], feedbacks=fbs({
                        1: HighlightSolution(),
            ...
            extra_attribute_mistakes := mtc(n="Extra attribute mistakes", mistakeTypes=[
                plural_attribute := mt(n="Plural attribute", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(text="Double check this attribute name."),
                ...
                list_attribute := mt(n="List attribute", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            attribute_property_mistakes := mtc(n="Attribute property mistakes", mistakeTypes=[
                wrong_attribute_type := mt(n="Wrong attribute type", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                missing_attribute_type := mt(n="Missing attribute type", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                attribute_should_be_static := mt(n="Attribute should be static", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                ...
                attribute_should_not_be_static := mt(n="Attribute should not be static", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(text="Double check the properties of this attribute."),
    ...
    relationship_mistakes := mtc(n="Relationship mistakes", subcategories=[
        missing_association_aggregation_mistakes := mtc(n="Missing association/aggregation mistakes", mistakeTypes=[
            missing_association := mt(n="Missing association", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightProblem(),
            ...
            missing_aggregation := mt(n="Missing aggregation", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightProblem(),
                2: TextResponse(text="How should this relationship be modeled?"),
            ...
            missing_n_ary_association := mt(n="Missing n-ary association", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightProblem(),
                2: TextResponse(text="How should this relationship be modeled?"),
        ...
        extra_association_mistakes := mtc(n="Extra association mistakes", mistakeTypes=[
            extra_association := mt(n="Extra association", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            extra_aggregation := mt(n="Extra aggregation", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            extra_n_ary_association := mt(n="Extra n-ary association", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
                2: TextResponse(text="Is this association really necessary?"),
        ...
        multiplicity_mistakes := mtc(n="Multiplicity mistakes", mistakeTypes=[
            infinite_recursive_dependency := mt(n="Infinite recursive dependency", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            wrong_multiplicity := mt(n="Wrong multiplicity", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            missing_multiplicity := mt(n="Missing multiplicity", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
                2: TextResponse(text="Double check this association."),
        ...
        role_name_mistakes := mtc(n="Role name mistakes", mistakeTypes=[
            missing_role_name := mt(n="Missing role name", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            role_should_be_static := mt(n="Role should be static", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            role_should_not_be_static := mt(n="Role should not be static", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            bad_role_name_spelling := mt(n="Bad role name spelling", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            wrong_role_name := mt(
                n="Wrong role name", d="Wrong role name but correct association", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(text="Double check this role name."),
        ...
        association_type_mistakes := mtc(n="Association type mistakes", mistakeTypes=[
            ...
            reversed_relationship_direction := mt(n="Reversed relationship direction", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            using_composition_instead_of_aggregation := mt(
                n="Using composition instead of aggregation", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
        ...
        association_name_mistakes := mtc(n="Association name mistakes", mistakeTypes=[
            missing_association_name := mt(n="Missing association name", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            bad_association_name_spelling := mt(n="Bad association name spelling", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
        ...
        association_class_mistakes := mtc(n="Association class mistakes", mistakeTypes=[
            missing_assoc_class := mt(n="Missing assoc class", d="Missing association class", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightProblem(),
                2: TextResponse(text="Can you model this relationship more precisely?"),
            ...
            extra_assoc_class := mt(n="Extra assoc class", d="Extra association class", stud="attr", inst=[], feedbacks=fbs({
                1: HighlightSolution(),
            ...
            bad_assoc_class_name_spelling := mt(
                n="Bad assoc class name spelling", d="Bad association class name spelling", stud="attr", inst=[], feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            assoc_class_should_be_class := mt(
                n="Assoc class should be class", d="Association class should be regular class", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            class_should_be_assoc_class := mt(
                n="Class should be assoc class", d="Regular class should be association class", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
        ...
        composition_mistakes := mtc(n="Composition mistakes", mistakeTypes=[
            missing_composition := mt(n="Missing composition", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightProblem(),
                2: TextResponse(text="How should this relationship be modeled?"),
                3: ParametrizedResponse(text="How would you capture that a ${inst_whole_assocend.refcls} has a "
                                             "${inst_part_assocend.refcls}?"),
            ...
            extra_composition := mt(n="Extra composition", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
            ...
            using_assoc_instead_of_aggregation := mt(
                n="Using assoc instead of aggregation", d="Using association instead of aggregation", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(text="What is the relationship between these two concepts?"),
                    3: ParametrizedResponse(text="The relationship between ${stud_assocend.cls} and "
            ...
            using_assoc_instead_of_composition := mt(
                n="Using assoc instead of composition", d="Using association instead of composition", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(text="What is the relationship between these two concepts?"),
                    3: ParametrizedResponse(text="The relationship between ${stud_assocend.cls} and "
            ...
            using_aggregation_instead_of_composition := mt(n="Using aggregation instead of composition", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
                2: TextResponse(text="Is this the best relationship to use here?"),
                3: ParametrizedResponse(text="The relationship between ${stud_part_assocend.cls} and "
            ...
            composed_part_contained_in_more_than_one_parent := mt(
                n="Composed part contained in more than one parent", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            incomplete_containment_tree := mt(n="Incomplete containment tree", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
        ...
        generalization_mistakes := mtc(n="Generalization mistakes", mistakeTypes=[
            missing_generalization := mt(n="Missing generalization", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightProblem(),
            ...
            extra_generalization := mt(n="Extra generalization", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
            ...
            generalization_inapplicable := mt(
                n="Generalization inapplicable", d="Generalization does not follow isA rule", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                    2: [TextResponse(text="Can you find a better way to express this relationship?"),
                        TextResponse(text="Is there a [direct ]relationship between these two classes?")],
                    3: [ParametrizedResponse(text="When creating a generalization between ${stud_sub_cls} and "
            ...
            subclass_not_distinct_across_lifetime := mt(n="Subclass not distinct across lifetime", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
            ...
            inherited_feature_does_not_make_sense_for_subclass := mt(
                n="Inherited feature does not make sense for subclass", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
            ...
            subclass_is_an_instance_of_superclass := mt(n="Subclass is an instance of superclass", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
                2: TextResponse(text="Can you find a better way to express this relationship?"),
            ...
            non_differentiated_subclass := mt(n="Non-differentiated subclass", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
            ...
            reversed_generalization_direction := mt(n="Reversed generalization direction", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
            ...
            wrong_superclass := mt(n="Wrong superclass", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightSolution(),
                2: TextResponse(text="Can you double check this relationship?"),
    ...
    design_pattern_mistakes := mtc(n="Design pattern mistakes", subcategories=[
        player_role_pattern_mistakes := mtc(n="Player-Role pattern mistakes", mistakeTypes=[
            missing_pr_pattern := mt(n="Missing PR pattern", d="Missing Player-Role pattern", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                1: HighlightProblem(),
            ...
            incomplete_pr_pattern := mt(
                n="Incomplete PR pattern", d="Incomplete Player-Role pattern", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(
        ...
        abstraction_occurrence_pattern_mistakes := mtc(n="Abstraction-Occurrence pattern mistakes", mistakeTypes=[
            missing_ao_pattern := mt(
                n="Missing AO pattern", d="Missing Abstraction-Occurrence pattern", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightProblem(),
                    2: TextResponse(
            ...
            incomplete_ao_pattern := mt(
                n="Incomplete AO pattern", d="Incomplete Abstraction-Occurrence pattern", stud=["assoc", "cls"], inst="cls", feedbacks=fbs({
                    1: HighlightSolution(),
                    2: TextResponse(
                        text="Think carefully about how to model the relationship between these concepts."),
                    3: ParametrizedResponse(
