...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>learningcorpus</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class LearningcorpusExample {
  /**
   * <!-- begin-user-doc -->
  ...
  public static void main(String[] args) {
    ...
    resourceSet.getPackageRegistry().put
      (LearningcorpusPackage.eNS_URI, 
       LearningcorpusPackage.eINSTANCE);
